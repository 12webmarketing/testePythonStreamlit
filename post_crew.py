...
# Definindo os agentes
        pesquisador = Agent (
            ...
            verbose = True ,
            memory = True ,
            backstory ='''Você é um pesquisador especializado em
            descobrir informações útis e relevantes
        ...
        pesquisa_tarefa = Task (
            description =
            ''' Pesquise informa ções detalhadas sobre
        ...
        escrita_tarefa = Task (
            description =''' Escreva uma postagem com base no
        ...
        revisao_tarefa = Task (
            description = '''Reveja a postagem criada , ajustando a
            clareza e corrigindo poss í veis erros . ''' ,
    ...
    def kickoff ( self , inputs ) :
        # Executa o Crew com o tó pico fornecido
